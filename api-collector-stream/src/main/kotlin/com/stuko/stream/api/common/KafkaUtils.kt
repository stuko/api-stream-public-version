...
class KafkaUtils{
    ...
    companion object {
        ...
        public fun getProperties(type: String, serverIp: String?, sameGroup:Boolean, pollSize: Int = 500 ): Properties? {
            when (type) {
                "admin" -> {
                ...
                "consumer" -> {
                    return Properties().also {
                        ...
                        it["enable.auto.commit"] = "true";
                        it["max.poll.records"] = pollSize.toString();
                        it["auto.offset.reset"] = "latest";
        ...
        public fun getConsumer(isNew: Boolean, serverIp: String, topicName: String , sameGroup: Boolean, pollSize: Int = 500): KafkaConsumer<Any, Any>? {
            return startConsumer(isNew, getProperties("consumer", serverIp, sameGroup, pollSize), topicName)
        }
